        ...
        <div class="modal-content">
          ...
          <p class="guidance guidance--warning">
            {{ acaoAdministrativa === 'CANCELAR'
              ...
              : 'O resíduo voltará exatamente uma etapa do ciclo. Dados históricos permanecem registrados e a justificativa será auditável.' }}
          </p>
          <label class="field">
            <span>Justificativa administrativa</span>
            <textarea v-model="justificativaAdministrativa" maxlength="1000" rows="4" placeholder="Explique por que esta correção é necessária..." />
          </label>
          <div v-if="erroAdministracao" class="feedback feedback--error modal-operation-error">{{ erroAdministracao }}</div>
        </div>
        <footer>
...
.admin-return-action { border: 0; border-radius: 7px; background: #b7791f; color: #fff; font: inherit; font-size: 11px; font-weight: 850; cursor: pointer; padding: 0 14px; }
.admin-cancel-action { border: 0; border-radius: 7px; background: #a8322a; color: #fff; font: inherit; font-size: 11px; font-weight: 850; cursor: pointer; padding: 0 14px; }
