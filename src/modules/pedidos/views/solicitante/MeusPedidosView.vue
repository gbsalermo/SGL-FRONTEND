  ...
  <section class="pedidos-page">
    ...
    <section class="filter-surface">
      <div class="search-control">
        ...
        <input v-model="busca" type="search" placeholder="Buscar por produto, projeto ou observação..." />
      </div>
        ...
        <table>
          ...
          <tbody>
            <tr v-for="pedido in pedidosFiltrados" :key="pedido.id">
              ...
              <td>
                <strong class="table-primary">{{ pedido.projetoNome ?? 'Sem projeto' }}</strong>
...
.summary-card {
  ...
  border-radius: 9px;
  background: #fff;
  box-shadow: 0 5px 18px rgb(15 37 71 / 4%);
}
...
.table-surface {
  ...
  border-radius: 9px;
  background: #fff;
  box-shadow: 0 7px 24px rgb(15 37 71 / 5%);
}
...
.detail-dialog {
  ...
  border-radius: 10px;
  background: #fff;
  box-shadow: 0 24px 60px rgb(5 16 37 / 25%);
}
